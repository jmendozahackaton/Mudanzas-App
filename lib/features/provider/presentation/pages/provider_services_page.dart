...
class _ProviderServicesPageState extends State<ProviderServicesPage> {
  ...
  void _loadProviderMovings() {
    context.read<MovingBloc>().add(GetProviderMovingsEvent(
          page: _currentPage,
          limit: _limit,
        ));
  }
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: _loadProviderMovings,
            tooltip: 'Actualizar',
          ),
        ],
      ),
      body: BlocBuilder<MovingBloc, MovingState>(
        builder: (context, state) {
          ...
          if (state is ProviderMovingsLoaded) {
      ...
      child: ListTile(
        ...
        subtitle: Column(
          ...
          children: [
            ...
            Text('Cliente: ${moving.clienteNombre} ${moving.clienteApellido}'),
            Text('Origen: ${moving.direccionOrigen}'),
            Text('Destino: ${moving.direccionDestino}'),
            const SizedBox(height: 4),
            Row(
              children: [
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _buildDetailItem('Cliente',
                  '${moving.clienteNombre} ${moving.clienteApellido}'),
        ...
        actions: [
          ...
          if (moving.estado == 'asignada' ||
              moving.estado == 'en_camino' ||
              moving.estado == 'en_proceso')
            ElevatedButton(
              onPressed: () => _showStatusUpdateDialog(moving),
  ...
  void _showStatusUpdateDialog(moving) {
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setState) => AlertDialog(
          ...
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              const Text('Selecciona el nuevo estado del servicio:'),
              const SizedBox(height: 16),
              DropdownButtonFormField<String>(
                ...
                items: [
                  ...
                  if (moving.estado == 'en_camino') ...[
                    const DropdownMenuItem(
                        value: 'en_proceso', child: Text('En Proceso')),
                    const DropdownMenuItem(
                        value: 'cancelada', child: Text('Cancelar')),
                  ],
                  if (moving.estado == 'en_proceso') ...[
                    const DropdownMenuItem(
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: selectedStatus != null
                  ? () => _updateMovingStatus(moving.id, selectedStatus!)
                  : null,
